package com.faskalis.formapp02;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        EditText inputPassowrd = (EditText) findViewById(R.id.id_input_pwd);
        ...
        btnSave.setOnClickListener(v ->{
            ...
            loginIntent.putExtra(EXTRA_NAME, inputPhone.getText().toString());
